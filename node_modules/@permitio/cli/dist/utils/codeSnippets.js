export const generateVitestSample = (pdp_url, config_path, api_key) => {
...
export const generateJestSample = (pdp_url, config_path, api_key) => {
...
export const generatePytestSample = (pdp_url, config_path, api_key) => {
    return `import json
import pytest
import asyncio
