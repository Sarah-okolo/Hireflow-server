...
export const options = zod.object({
    ...
    'pdp-url': zod
        ...
        .describe(option({
        description: 'The URL of the PDP service. Defaults to http://localhost:7766. (Optional)',
    })),
    apiKey: zod
        .string()
        .optional()
...
export default function CheckUrl({ options }) {
    return (React.createElement(AuthProvider, { scope: 'environment', permit_key: options.apiKey },
        React.createElement(PDPCheckUrlComponent, { options: options })));
}
