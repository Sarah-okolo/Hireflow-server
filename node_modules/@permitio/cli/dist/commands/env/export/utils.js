export function createSafeId(...parts) {
    return parts
 ...
 */
export async function fetchList(listFunction, baseParams, page = 1, perPage = 100) {
    let allResults = [];
    ...
    while (hasMoreResults) {
        ...
        if (Array.isArray(response)) {
            ...
            if (response.pagination) {
                const { page = 1, per_page = perPage, total_count, } = response.pagination;
