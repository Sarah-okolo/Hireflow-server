...
export const ExportContent = ({ options: { key: apiKey, file }, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(ExportStatus, { state: state, file: file }),
        !file && hclOutput && (React.createElement(Text, null,
            React.createElement(Text, null, hclOutput))),
        state.error && React.createElement(Text, { color: "red" }, state.error)));
};
