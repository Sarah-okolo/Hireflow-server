...
import { ApplyTemplate, getDirectory, } from '../../../lib/env/template/utils.js';
...
export const TFChatComponent = () => {
    ...
    const [terraformOutput, setTerraformOutput] = useState(null);
    ...
    return (React.createElement(Box, { flexDirection: "column" },
        messages.map((msg, i) => (React.createElement(Text, { key: i, color: msg.role === 'user' ? 'blue' : 'green' },
            msg.role === 'user' ? 'You: ' : 'Assistant: ',
            msg.content))),
        isWaitingForResponse && currentResponse && (React.createElement(Text, { color: "yellow" },
            "Assistant: ",
            currentResponse)),
        !isWaitingForResponse && tableData && (React.createElement(PolicyTables, { tableData: tableData, waitingForApproval: waitingForApproval })),
        isApplyingTerraform && (React.createElement(Box, null,
            React.createElement(Text, { color: "yellow" },
                React.createElement(Spinner, { type: "dots" }),
                " Applying Terraform plan..."))),
        !isApplyingTerraform && terraformSuccess && (React.createElement(Text, { color: "green" }, "Assistant: Terraform file generated successfully!")),
        !chatEnded && !inputDisabled && (React.createElement(TextInput, { value: input, onChange: setInput, onSubmit: handleSubmit, placeholder: waitingForApproval
                ? "Type 'yes' or 'no'..."
                : 'Type your message...' }))));
};
