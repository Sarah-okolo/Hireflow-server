...
export const useOpenapiApi = () => {
    const { listResources, createResource, updateResource, createAction } = usePermitResourceApi();
    const { listRoles, getRole, createRole, updateRole, createResourceRole } = usePermitRoleApi();
    const { getRelationByKey, createRelation, createDerivedRole } = usePermitRelationApi();
