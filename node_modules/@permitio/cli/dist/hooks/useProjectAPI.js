...
export const useProjectAPI = () => {
    ...
    const getProjects = useCallback(async (accessToken, cookie) => {
        return accessToken || cookie
            ? await unAuthenticatedApiClient(accessToken, cookie).GET('/v2/projects')
            : await authenticatedApiClient().GET('/v2/projects');
    }, [authenticatedApiClient, unAuthenticatedApiClient]);
    const getProject = useCallback(async (proj_id) => {
