...
import { IAction, ICheckQuery, IResource, IUser, IUserPermissions, TenantDetails } from './interfaces';
...
export interface IEnforcer {
     ...
     */
    checkAllTenants(user: IUser | string, action: string, resource: IResource | string, context: Context | undefined, sdk: string | undefined): Promise<TenantDetails[]>;
}
/**
...
export declare class Enforcer implements IEnforcer {
    ...
    checkAllTenants(user: IUser | string, action: string, resource: IResource | string, context?: Context, // default to empty context if not provided
    sdk?: string): Promise<TenantDetails[]>;
